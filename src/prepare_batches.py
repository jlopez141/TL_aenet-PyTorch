...
def read_list_structures(tin):
	...
	if tin.mode == "transfer":
		for iesp in range(tin.N_species):
			tin.setup_params.sfval_avg[iesp] = tin.transfer_setup_params.sfval_avg[iesp]
			tin.setup_params.sfval_cov[iesp] = tin.transfer_setup_params.sfval_cov[iesp]
			tin.setup_params.sfval_min[iesp] = tin.transfer_setup_params.sfval_min[iesp]
			tin.setup_params.sfval_max[iesp] = tin.transfer_setup_params.sfval_max[iesp]
