...
def read_setup_iesp(f):
	...
	sfval_min   = np.array([ float(x) for x in f.readline().split() ])
	sfval_max   = np.array([ float(x) for x in f.readline().split() ])
	sfval_avg   = np.array([ float(x) for x in f.readline().split() ])
	sfval_cov   = np.array([ float(x) for x in f.readline().split() ])
